...
# Substitute: ecos, coworld-ecos, 3.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-ecos:ci)
#   SMOKE_SLUG                 game slug                        (ecos)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/ecos)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/ecos-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-ecos:ci}}"
slug="${SMOKE_SLUG:-ecos}"
